...
namespace template_funcs{
	...
	template <class T> T convert_J_eV(T a)
	{
		// convert the value a from Joules to electronvolts

		return 6.241509e18 * a; 
	}

	template <class T> T convert_ev_J(T a)
	{
		// convert the value a from electronvolts to Joules

		return 1.602176565e-19 * a; 
	}
